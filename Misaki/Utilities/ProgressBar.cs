...
{
    //await Logger.Log("Performing some task... ", InfoSource.Misaki);
    ...
    //await Logger.Log("Done.", InfoSource.Misaki);
    public class ProgressBar : IDisposable, IProgress<double>
    {
        ...
        private ConsoleColor[] allowedColors = new ConsoleColor[]
{
    ...
    ConsoleColor.White
        ...
        private void TimerHandler(object state)
        {
            lock (timer)
            {
                ...
                int index = random.Next(allowedColors.Length);
                Console.ForegroundColor = allowedColors[index];
                UpdateText(text);
                ResetTimer();
            }
        }
